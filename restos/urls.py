...
urlpatterns = [
    ...
    url(r'^like-resto/([0-9]+)/$', views.LikeResto.as_view(), name='like_resto'),
    url(r'^dislike-resto/([0-9]+)/$', views.DislikeResto.as_view(),name='dislike_resto'),
    url(r'^reserve/([0-9]+)/([0-9]+)/$', views.MakeReservation.as_view(), name='reserve'),
